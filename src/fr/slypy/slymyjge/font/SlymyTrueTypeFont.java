...
public class SlymyTrueTypeFont implements Font {
	 ...
	 */
	public SlymyTrueTypeFont(java.awt.Font font, boolean antiAlias, char[] additionalChars) {
	 ...
	 *            Whether or not to apply AntiAliasing to the cached font
	 */
	public SlymyTrueTypeFont(java.awt.Font font, boolean antiAlias) {
